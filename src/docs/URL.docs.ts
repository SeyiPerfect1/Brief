const createURL = {
  ...
  responses: {
    "201": {
      description:
        "Shortened URL created successfully created successfully, it returns the short url and te base64 string of the qrcode of the URL",
      content: {
        "application/json": {
          schema: {
            type: "object",
            properties: {
              ...
              qrCodeDownloadLink: {
                type: "string",
                example:
                  "kkkkbe28y28yvfuyrohvbwvwy-25vvrhf8y8344cw-4r93r3993ukvkre-35niiririri-rjrrururu-rururururururuururuurururjgjjgjgjgjgjjgkkdeeueueueuueueusdgdgyeururhffh",
              },
            },
          },
        },
    ...
    "200": {
      description:
        "send the shorturl and qrcode base64 string if already in the cache",
      content: {
        "application/json": {
          schema: {
            type: "object",
...
const createURLBody = {
  ...
  properties: {
    originalURL: {
      type: "string",
      example:
        "https://facebook.com/profile/arfwufwfewefew/ff924fqfcfikvev/djcbh23kndkcwefwenf/cicwefhf2i32?nkcndef'nr+rihr-virir_fnnveroe",
      require: true,
    },
    customDomain: {
      type: "string",
