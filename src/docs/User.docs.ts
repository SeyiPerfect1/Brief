...
const resetpasswordUser = {
  tags: ["Auth"],
  description:
    "Reset user Password By Using The Link Sent From Forgot Password Endpoint",
...
const createUserBody = {
  ...
  properties: {
    ...
    password: {
      type: "string",
      description:
        "unencrypted user's password, password must contain capital letter, small letter, a special character and must be at least 6 chars",
      example: "!1234aWe1Ro3$#",
    },
  },
};
